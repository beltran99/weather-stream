...
hourly_evapotranspiration = hourly.Variables(19).ValuesAsNumpy()
hourly_et0_fao_evapotranspiration = hourly.Variables(20).ValuesAsNumpy()
hourly_vapour_pressure_deficit = hourly.Variables(21).ValuesAsNumpy()
...
hourly_soil_moisture_0_to_1cm = hourly.Variables(36).ValuesAsNumpy()
hourly_soil_temperature_54cm = hourly.Variables(37).ValuesAsNumpy()
...
value = hourly_dataframe.to_json(orient='records')
